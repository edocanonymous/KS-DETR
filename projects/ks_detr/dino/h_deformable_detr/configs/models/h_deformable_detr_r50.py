...
model = L(KSHDeformableDETR)(
    ...
    transformer=L(KSHDeformableDetrTransformer)(
        encoder=L(KSHDeformableDetrTransformerEncoder)(
            embed_dim=256,
            num_heads=8,
        ...
        decoder=L(KSHDeformableDetrTransformerDecoder)(
            embed_dim=256,
            num_heads=8,
            feedforward_dim=2048,
            attn_dropout=0.0,
