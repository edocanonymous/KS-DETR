...
from projects.dn_detr.modeling import DNCriterion
...
model = L(KSDNDETR)(
    ...
    transformer=L(KSDNDetrTransformer)(
        encoder=L(KSDNDetrTransformerEncoder)(
            ...
            # num_layers=6,
            encoder_layer_config='regular_6',  # encoder_layer_config: 'regular_6',  'regular_4-ksgtv1_1-ksgt_1'
            post_norm=False,
        ),
