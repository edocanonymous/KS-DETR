from .triple_head_smlp_qkv_share_outpro_ffn import ksgt_module

ksgt_module.token_masking_loc = 'V'
...
#     token_masking_loc='V',  # ['X', 'Q', 'K', 'V', 'QK', 'KV', 'MHA_out', 'MHA_feature', 'FFN_out', 'FFN_feature', ]
