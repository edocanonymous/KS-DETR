...
def multi_head_attention_forward(query: Tensor,
                                 ...
                                 out_dim: Optional[Tensor] = None, average_attn_weights=False
    ...
    attn_output_weights_before_softmax = attn_output_weights.clone()
    ...
    if need_weights:
        ...
        attn_output_weights_before_softmax = attn_output_weights_before_softmax.view(bsz, num_heads, tgt_len, src_len)
