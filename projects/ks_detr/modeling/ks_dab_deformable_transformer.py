...
from projects.dab_deformable_detr.modeling import DabDeformableDetrTransformer
...
class KSDabDeformableDetrTransformerEncoder(KSTransformerLayerSequence):
    def __init__(
        self,
        embed_dim: int = 256,
        num_heads: int = 8,
        ...
        # super(KSDabDeformableDetrTransformerEncoder, self).__init__(
...
class KSDabDeformableDetrTransformerDecoder(KSTransformerLayerSequence):
    def __init__(
        self,
        embed_dim: int = 256,
        num_heads: int = 8,
        ...
        # --------------------
        # super(KSDabDeformableDetrTransformerDecoder, self).__init__(
        #     transformer_layers=BaseTransformerLayer(
        #         attn=[
        #             MultiheadAttention(
        #                 embed_dim=embed_dim,
...
class KSDabDeformableDetrTransformer(DabDeformableDetrTransformer):
...
class KSDabDeformableDetrMultiAttnTransformer(KSDabDeformableDetrTransformer):
