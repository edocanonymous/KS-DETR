...
from projects.ks_detr.modeling.sgdt.sgdt_deprecated import build_sgdt
...
class SGDT_DABDETR(DABDETR):
    ...
    def forward(self, samples: NestedTensor, dn_args=None, sgdt_args=None,
        ...
        # out = {'pred_logits': outputs_class[5], 'pred_boxes': outputs_coord[5]}
        # out = {}
        if self.aux_loss:
