...
class DecoderMultiheadCrossAttention(Module):
    ...
    def __setstate__(self, state):
        ...
        super(DecoderMultiheadCrossAttention, self).__setstate__(state)
...
def multi_head_attention_forward(query: Tensor,
    ...
    '''
    a = softmax(attn_output_weights - attn_output_weights.max(dim=-1, keepdim=True)[0], dim=-1)
    b = softmax(attn_output_weights, dim=-1)
    c = torch.equal(a, b)  -> True
    '''
    attn_output_weights = softmax(
    ...
    if need_weights:
        ...
        return attn_output, attn_output_weights.sum(dim=1) / num_heads, attn_output_weights_logits
    else:

        return attn_output, None, attn_output_weights_logits
