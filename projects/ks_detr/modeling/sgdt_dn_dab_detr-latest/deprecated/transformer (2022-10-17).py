...
def build_transformer(args):
    if args.feature_distillation is not None:
        if args.feature_distillation == 'parallel':
            transformer = TransformerSelfDistillation
        elif args.feature_distillation == 'cascade':
            transformer = TransformerSGDT
        elif args.feature_distillation == 'separate_trained_model':
