...
class KSHDeformableDetrTransformerEncoder(KSTransformerLayerSequence):
    def __init__(
        self,
        embed_dim: int = 256,
        num_heads: int = 8,
        ...
        super(KSHDeformableDetrTransformerEncoder, self).__init__(
...
class KSHDeformableDetrTransformerDecoder(KSTransformerLayerSequence):
    def __init__(
        self,
        embed_dim: int = 256,
        num_heads: int = 8,
        ...
        super(KSHDeformableDetrTransformerDecoder, self).__init__(
            transformer_layers=BaseTransformerLayer(
                attn=[
                    MultiheadAttention(
                        embed_dim=embed_dim,
...
class KSHDeformableDetrTransformer(nn.Module):
    ...
    def __init__(
        ...
        super(KSHDeformableDetrTransformer, self).__init__()
