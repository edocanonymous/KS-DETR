...
# ------------------------------------------------------------------------------------------------
# Modified from:
# https://github.com/Atten4Vis/ConditionalDETR/blob/KSGroupDETR/models/conditional_detr.py
# ------------------------------------------------------------------------------------------------
...
class KSGroupDETR(GroupDETR):
    ...
    Args:
        ...
        group_num (int): The number of query groups used in KSGroupDETR. Default: 11.
