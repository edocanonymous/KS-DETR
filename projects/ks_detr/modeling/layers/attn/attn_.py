...
class MultiheadAttentionSeparateWeight(Module):
...
def _in_projection_packed(
    ...
    if k is v:
        ...
        w_q, w_k, w_v = w.chunk(3)  # w: torch.Size([768, 256])
        if b is None:
            b_q = b_k = b_v = None
        else:
...
# ====================
# old version without average_attn_weights
# ====================
...
#
#         # not average attention weights over heads
#         # attn_output_weights = attn_output_weights.view(bsz, num_heads, tgt_len, src_len)
#         # return attn_output, attn_output_weights
#
#     else:
