...
from .triple_attn_share_AV import linear_


class MultiheadAttentionShareV(Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor,
                ...
                key_teacher: Tensor,
                value_teacher: Optional[Tensor] = None,  # They are not used, keep them here for unified way of calling
