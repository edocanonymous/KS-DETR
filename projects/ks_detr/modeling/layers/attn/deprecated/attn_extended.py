...
from .attn import _mha_shape_check, _in_projection
...
class MultiheadAttentionExtended(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        super(MultiheadAttentionExtended, self).__init__()
    ...
    def __setstate__(self, state):
        ...
        super(MultiheadAttentionExtended, self).__setstate__(state)
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            ...
            # attn_output, attn_output_weights, attn_output_weights_logits = F.multi_head_attention_forward(
            #     query, key, value, self.embed_dim, self.num_heads,
            #     self.in_proj_weight, self.in_proj_bias,
            #     self.bias_k, self.bias_v, self.add_zero_attn,
            #     self.dropout, self.out_proj.weight, self.out_proj.bias,
...
def _in_projection_packed(
    ...
    if k is v:  # will not go to this branch
        ...
        # Modification here
        if freeze_wq or freeze_wk or freeze_wv:
            if freeze_wq:
