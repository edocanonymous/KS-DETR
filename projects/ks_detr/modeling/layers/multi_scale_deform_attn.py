...
from detrex.layers.multi_scale_deform_attn import create_dummy_class, multi_scale_deformable_attn_pytorch,\
...
class KSBaseMultiScaleDeformableAttention(MultiScaleDeformableAttention):
    ...
    def forward(
        ...
        **kwargs
        ...
        # Save the logits of the attention map
        attn_output_weight_logits = attention_weights.clone()
...
class KSMultiScaleTripleAttention(KSBaseMultiScaleDeformableAttention):
    def __init__(
            self,
            embed_dim: int = 256,
            num_heads: int = 8,
    ...
    def forward(
        ...
        self_attn_out_dict = dict(
            attn_map_logits=(attn_output_weight_logits, attn_output_weight_logits_teacher, attn_output_weight_logits),
