...
class SGDT_module(nn.Module):
    ...
    def forward(self, x, mask=None,
        ...
        # 'pred_significance_all_fg_w_priority_and_reclaim_padded_region'
            ...
            with_sgdt_targets = torch.tensor([v.find('debug') for v in discard_split_configs]).any()
            sgdt_targets_new = sgdt_targets if with_sgdt_targets else None
