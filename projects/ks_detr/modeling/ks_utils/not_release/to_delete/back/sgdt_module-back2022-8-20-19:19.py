...
class SGDT_module(nn.Module):
    ...
    def discard_split_significance_all_fg_w_priority(
        ...
        return token_dict, None, significance_score_logit, valid_tokens_float
    ...
    def _extract_adapted_token(self, x, tokens_to_discard_original,
                               tokens_to_split_original, significance_score,
                               small_scale_score
                               ):
        """
        ...
        Args:
            ...
            significance_score: lower score (less important bg tokens), higher priority of being sampled.
        ...
        for k in batch_ids:
            ...
            sig_values = significance_score[tokens_to_discard[:, k], k]
