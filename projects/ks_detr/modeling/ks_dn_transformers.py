...
class KSDNDetrMultiAttnTransformer(KSDNDetrTransformer):
    ...
    def forward_additional_attn_out(self, target, pos_embed, anchor_box_embed, attn_mask,
                                    # encoder_intermediate_output_list,
                                    intermediate_output_dict,
